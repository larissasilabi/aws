...
export class PerguntasService {
  ...
  private perguntas: Pergunta[] = [
    ...
    {id: 2, texto: '2) Qual a principal característica do produto EC2 da Amazon?', a: 'Elasticidade automática', b: 'Servidores virtuais na nuvem', c: 'Armazenamento escalável em nuvem', d: 'Banco de dados NoSQL gerenciado', correta: 'b'},
